...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Pictures/Instagram/IMG_20250322_223250.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Yogeswari S</h1>
    ...
    <section id="projects">
        <div class="section-content">
            ...
            <ul>
                ...
                <li><a href="#">Web design using html</a></li>
